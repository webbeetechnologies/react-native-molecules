...
<LiveCodeExample
    code={`import { ElementGroup } from 'react-native-molecules/components/ElementGroup';
...
export default function Example() {
    return (
        <ElementGroup style={{ borderRadius: 12 }}>
            ...
            <Button variant="contained" onPress={() => {}}>
                <Button.Icon name="chevron-down" size={26} />
            </Button>
        </ElementGroup>
    );
}`}
...
export default function Example() {
    return (
        <ElementGroup borderRadius={12}>
            ...
            <Button variant="contained" onPress={() => {}} style={{ height: undefined }}>
                <Button.Icon name="chevron-down" size={26} />
            </Button>
        </ElementGroup>
    );
...
import { ElementGroup, Select, TextInput, IconButton } from 'react-native-molecules/components/ElementGroup';
import type { TextInputProps } from 'react-native-molecules/components/TextInput';
...
export default function Example() {
    ...
    const inputProps = useMemo(
        () => ({ variant: 'outlined' } as TextInputProps),
        [],
    );
