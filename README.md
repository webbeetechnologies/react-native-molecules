...
The monorepo has package-specific scripts. Follow the instructions in [packages/molecules/README.md](packages/molecules/README.md) for accurate install, dev, and test commands.
